...
| 🆕 💎 🧠 [ReversecLabs/spikee](https://github.com/ReversecLabs/spikee) | Simple Prompt Injection Kit for Evaluation and Exploitation | 223 | +0 / +0 | `Research / Benchmark` | `Python` | `Apache-2.0` | 58 |
...
| 🆕 [mattolson/agent-sandbox](https://github.com/mattolson/agent-sandbox) | Secure local dev environment for collaboration with AI coding agents | 192 | +0 / +0 | `Tool / Framework` | `Python` | `MIT` | 22 |
...
| 🆕 [kstenerud/yoloai](https://github.com/kstenerud/yoloai) | AI agent sandboxing done right. | 170 | +0 / +0 | `Tool / Framework` | `Go` | `MIT` | 29 |
